  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="mx-auto flex min-h-screen w-full max-w-5xl flex-col px-5 py-8 sm:px-8">
        <header className="flex items-center justify-between gap-4"><div className="flex items-center gap-2 text-slate-400"><AmezingLogo dark compact /><span className="text-xs">Amezing Limited</span></div></header>
        ...
        <footer className="border-t border-slate-800 pt-5 text-xs text-slate-500">Business information published by {company.name}. Amezing Limited.</footer>
      </div>
    </main>
  );
}
