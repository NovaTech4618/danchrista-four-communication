  ...
  return <AppLayout><div className="mx-auto w-full max-w-5xl space-y-6">
    ...
    <div className="sticky top-[72px] z-20 rounded-xl border border-slate-200 bg-white p-2 shadow-sm">
      <div className="relative flex items-center">
        ...
        <input autoFocus value={q} onChange={(e) => setQ(e.target.value)} onKeyDown={(e) => { if (e.key === "Escape") setQ(""); }} placeholder="Name, phone, IMEI, SKU, repair, invoice or supplier…" aria-label="Search Danchrista records" className="h-12 w-full rounded-lg border-0 bg-slate-50 pl-11 pr-11 text-sm outline-none ring-1 ring-inset ring-slate-200 focus:bg-white focus:ring-2 focus:ring-[#1d6a54]" />
