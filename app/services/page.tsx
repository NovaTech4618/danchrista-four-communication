...
export const metadata: Metadata = {
  title: "Services | Danchrista Four Communication",
  description: "Explore phone repair, software service, phone parts, accessories and shop support from Danchrista Four Communication.",
...
export default function ServicesPage() {
  return <main className="min-h-screen bg-[#0b1512] text-[#f4f1ea]">
    ...
    <section className="px-5 py-16 sm:px-7 sm:py-24"><div className="mx-auto max-w-6xl">
      <p className="font-mono text-[11px] uppercase tracking-[0.16em] text-[#e7b784]">What Danchrista does</p>
      ...
      <div className="mt-12 rounded-2xl border border-white/10 bg-[#101f1a] p-7"><h2 className="font-heading text-2xl font-bold">Need help with something specific?</h2><p className="mt-2 text-sm leading-6 text-[#93a69c]">Contact Danchrista with the phone model, the problem or the item you need so availability can be checked.</p><Link href="/contact" className="mt-6 inline-flex items-center gap-2 rounded-lg bg-[#c98a4f] px-5 py-3 text-sm font-semibold text-[#1a1008]">Contact us <ArrowRight className="size-4" /></Link></div>
    </div></section>
  </main>;
}
