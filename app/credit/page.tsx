...
export default function CreditPage() {
  ...
  return <AppLayout><main className="space-y-6">
    <header className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between"><div><p className="text-xs font-bold uppercase tracking-[0.18em] text-[#8a641d]">Credit book</p><h1 className="mt-1 font-heading text-3xl font-bold tracking-tight text-[#182a28]">People Danchrista Owes</h1><p className="mt-1 max-w-2xl text-sm leading-6 text-[#74837e]">Goods or value we collected from someone and still need to pay. Credit stays separate from people who owe Danchrista.</p></div><Link href="/outstanding" className="inline-flex min-h-11 items-center justify-center rounded-xl border border-[#dfe6df] bg-white px-5 text-sm font-bold text-[#183b34]">People who owe us</Link></header>
