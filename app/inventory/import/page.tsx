...
const headers = ["item_name","category","subcategory","item_type","brand","compatible_models","sku","selling_price","minimum_selling_price","cost_price","quantity","minimum_stock","supplier","shelf_location","notes","image_url"];
